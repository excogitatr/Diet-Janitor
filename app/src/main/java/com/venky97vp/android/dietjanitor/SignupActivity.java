...
public class SignupActivity extends AppCompatActivity {
    ...
    private EditText mPasswordView,mConfPassword;
...
//        }
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)  && !isPasswordValid(confPassword)) {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                Toast.makeText(getApplicationContext(), R.string.alert_signup,
